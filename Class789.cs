...
internal class Class789
{
    private Class789()
    {
    }

    public static Class1092 smethod_0(Stream A_0, Encoding A_1)
    {
        StreamWriter writer = new StreamWriter(A_0, A_1) {
            NewLine = BookmarkStart.b("␨K", 3)
        };
        return new Class1092(A_0);
    }

    public static XmlReader smethod_1(Stream A_0)
    {
        return XmlReader.Create(A_0);
    }
