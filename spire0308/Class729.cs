...
{
    internal static PointF[] smethod_0(Class891[] A_0)
    {
        return smethod_1(A_0, null);
    }

    private static PointF[] smethod_1(Class891[] A_0, int[] A_1)
    {
        if (A_0 == null)
        {
            return null;
    ...
    private static void smethod_10(Class672 A_0)
    {
    ...
    private static RectangleF smethod_12(Class672 A_0)
    {
        Size coordSize = A_0.method_28().CoordSize;
        A_0.method_13(new Class679[2]);
    ...
    private static void smethod_13(Class672 A_0, int A_1, Size A_2)
    {
        int num;
        int num2;
    ...
    private static float smethod_15(Class623 A_0, int[] A_1)
    {
    ...
    internal static int[] smethod_17(ShapeObject A_0)
    {
        ...
        for (int i = 0; i < formulas.Length; i++)
        {
            ...
            int num2 = class2.method_0() ? smethod_18(A_0, numArray, class2.int_1) : class2.int_1;
            int num = class2.method_1() ? smethod_18(A_0, numArray, class2.int_2) : class2.int_2;
            int num4 = class2.method_2() ? smethod_18(A_0, numArray, class2.int_3) : class2.int_3;
    ...
    private static int smethod_18(ShapeObject A_0, int[] A_1, int A_2)
    {
        ...
        throw new ArgumentOutOfRangeException(BookmarkStart.b("嬪䰬崮倰帲", num), string.Format(BookmarkStart.b("洪䈬崮尰䘲头嘶ᤸ堺尼匾≀㙂⥄♆㵈⹊⥌潎⅐㉒❔㙖㑘㹚⥜㩞፠䍢൤٦ᩨ䭪᭬๮ᵰٲၴ坶ᙸᵺ䝼彾婢뎂", num), A_2));
    }

    private static RectangleF smethod_2(ShapeObject A_0, int[] A_1)
    {
        bool flag = smethod_4(A_0);
        Class70[] textBoxRects = A_0.TextBoxRects;
        switch (textBoxRects.Length)
        {
            case 1:
                return smethod_8(textBoxRects[0], A_1);

            case 2:
                return smethod_8(flag ? textBoxRects[0] : textBoxRects[3], A_1);

            case 3:
                return smethod_3(A_0, textBoxRects, A_1);
    ...
    private static RectangleF smethod_3(ShapeObject A_0, Class70[] A_1, int[] A_2)
    {
        float num2;
        float num3;
        RectangleF ef;
        ...
        float num6;
        int index = 0;
        if ((A_1.Length == 6) && !smethod_4(A_0))
        {
            index = 3;
        }
        if ((A_0.Handles == null) || (A_0.Handles.Length == 0))
        {
            return smethod_8(A_1[index], A_2);
        }
        ...
        {
            num2 = smethod_15(class2.class623_2, A_2);
            num3 = smethod_15(class2.class623_3, A_2);
        }
        else
        {
            num2 = smethod_15(class2.class623_4, A_2);
            num3 = smethod_15(class2.class623_5, A_2);
        }
        float num4 = num2 + ((num3 - num2) / 2f);
        if (num5 < num4)
        {
            ef = smethod_8(A_1[index], A_2);
            ef2 = smethod_8(A_1[index + 1], A_2);
            num6 = smethod_5(num2, num4, (float) num5);
        }
        else
        {
            ef = smethod_8(A_1[index + 1], A_2);
            ef2 = smethod_8(A_1[index + 2], A_2);
            num6 = smethod_5(num4, num3, num5 - num4);
        }
        return smethod_6(ef, ef2, num6);
    }
    ...
    private static float smethod_5(float A_0, float A_1, float A_2)
    {
        return (A_2 / (A_1 - A_0));
    }

    private static RectangleF smethod_6(RectangleF A_0, RectangleF A_1, float A_2)
    {
        float x = smethod_7(A_0.X, A_1.X, A_2);
        float y = smethod_7(A_0.Y, A_1.Y, A_2);
        float width = smethod_7(A_0.Right, A_1.Right, A_2) - x;
        return new RectangleF(x, y, width, smethod_7(A_0.Bottom, A_1.Bottom, A_2) - y);
    }
    ...
    private static RectangleF smethod_8(Class70 A_0, int[] A_1)
    {
        float x = smethod_16(A_0.class623_0, A_1);
        float y = smethod_16(A_0.class623_1, A_1);
        float width = smethod_16(A_0.class623_2, A_1) - x;
        return new RectangleF(x, y, width, smethod_16(A_0.class623_3, A_1) - y);
    }

    private static void smethod_9(Class672 A_0, PointF[] A_1)
    {
