...
internal class Class600
{
    ...
    {
        EscherShapePath linesClosed = EscherShapePath.LinesClosed;
        object obj2 = A_0.method_31(0x144);
        if (obj2 != null)
        {
            linesClosed = (EscherShapePath) obj2;
            A_0.Remove(0x144);
        }
        ...
        else
        {
            switch (linesClosed)
            {
                case EscherShapePath.Lines:
                    classArray2 = smethod_2(classArray);
                    goto Label_0151;

                case EscherShapePath.LinesClosed:
                ...
                case EscherShapePath.CurvesClosed:
                {
