...
internal class Class813
{
    ...
    static Class813()
    {
        Class791.smethod_0(new object[] { 0, LocaleIDs.LanguageNotSet, 1, LocaleIDs.ja_JP, 2, LocaleIDs.zh_SG, 3, LocaleIDs.ko_KR, 4, LocaleIDs.zh_TW }, hashtable_0, hashtable_1);
    }
    ...
    internal static SubDocumentType smethod_21(SubDocumentType A_0)
    {
        ...
        throw new InvalidOperationException(BookmarkStart.b("笨个尬娮吰䀲䄴制崸ᬺ䤼娾㥀㝂敄╆♈㍊浌㱎⑐ㅒㅔ㡖㩘⹚ぜ㩞འᝢ䕤፦ၨ᭪࡬佮ᝰᱲݴ坶ၸᕺ୼ṾꞆﺊﾌﶎﶒ랖ﾜﮞ캠삢키쪦첨얪\ud9ac\u8fae얰쪲어튶鞸", num));
    }
    ...
    internal static LocaleIDs smethod_23(int A_0)
    {
        return (LocaleIDs) Class791.smethod_3(hashtable_0, A_0, LocaleIDs.LanguageNotSet);
    }

    internal static int smethod_24(LocaleIDs A_0)
    {
