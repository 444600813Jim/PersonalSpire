...
internal class Class265
{
    ...
    internal Class265(double A_0, double A_1, double A_2, double A_3)
    {
        this.double_0 = A_0;
        this.double_1 = A_1;
        this.double_2 = A_2;
    ...
    internal static bool smethod_0(double A_0)
    {
        ...
        if ((A_0 < 0.0) || (A_0 >= 45.0))
        {
            ...
            if (A_0 < 315.0)
            {
                throw new InvalidOperationException(BookmarkStart.b("猥䘧伩含席唯儱䀳匵尷ᨹ崻倽✿⹁⅃桅", num));
            }
        }
        return false;
    }
    ...
    {
        Class265 class2 = new Class265(A_1, A_2, A_3, A_4);
    ...
    internal static Class265 smethod_3(ShapeBase A_0)
    {
        Class265 class2;
        if ((A_0.ShapeType != ShapeType.Image) && (A_0.ShapeType != ShapeType.OleObject))
        {
            class2 = new Class265(A_0.Left, A_0.Top, A_0.Width, A_0.Height);
            if (smethod_0(A_0.Rotation))
            {
                class2.method_0();
            }
        ...
        float num = imageData.WidthScale / 100f;
        float num2 = imageData.HeightScale / 100f;
        class2 = new Class265(A_0.Left, A_0.Top, A_0.Width * num, A_0.Height * num2);
        if (smethod_0(A_0.Rotation))
        {
            class2.method_0();
        }
